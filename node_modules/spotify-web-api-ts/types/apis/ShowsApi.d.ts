...
export declare class ShowsApi {
    ...
    getShowEpisodes(showId: string, options?: GetShowEpisodesOptions): Promise<GetShowEpisodesResponse>;
    getShows(showIds: string[], options?: MarketOptions): Promise<Array<SimplifiedShow | null>>;
}
//# sourceMappingURL=ShowsApi.d.ts.map