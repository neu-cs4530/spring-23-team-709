...
import { FollowPlaylistOptions, GetFollowedArtistsOptions } from '../types/SpotifyOptions';
export declare class FollowApi {
    ...
    getFollowedArtists(options?: GetFollowedArtistsOptions): Promise<CursorBasedPaging<Artist>>;
